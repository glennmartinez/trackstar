...
class IssueController extends Controller
{
	...
	public function filters()
	{
		return array(
            ...
            'projectContext + create index admin', //defines a filter for the actioncreate '+'allows to add filter '-' specifies ignores
		);
	}
	...
	{
		$model=new Issue;
        //sets the issue id as per the project id selected
